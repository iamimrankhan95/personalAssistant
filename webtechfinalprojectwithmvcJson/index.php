...
/**
 * Created by PhpStorm.
 * User: Imran Ahmed Khan
 * Date: 11-01-2017
 * Time: PM 9.45
 */
    define('ds',DIRECTORY_SEPARATOR);
	define('APP_ROOT', "$_SERVER[DOCUMENT_ROOT]/myWorks/webtechfinalprojectwithmvcJson"); // define gula immediate pore page prjnto pabe
	//echo APP_ROOT ."<br>";
    define('PROTOCOL', ((!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') ||
    $_SERVER['SERVER_PORT'] == 443) ? "https://" : "http://");
    define('ROOT', PROTOCOL.$_SERVER['SERVER_NAME'].'/myWorks/webtechfinalprojectwithmvcJson');
    //echo ROOT;
	$hasError=true;
    if (count($_GET) == 0) {
        $view = "login";
