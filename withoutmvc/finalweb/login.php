...
if (isset($_COOKIE['loggedInUser'])) {
    ...
    if ($connection) {
        ...
        if ($row = mysqli_fetch_array($result = mysqli_query($connection, $sql))) {
            session_start();
            $_SESSION["id"] = $row['id'];
			 $_SESSION["name"] = $row['name'];
            ...
            if($_POST['remember']=='rememberme'){
                setcookie("loggedInUser",$_SESSION["id"],time()+((86400/24)/60));
            }
	...
	<div id="left">
        ...
        <table>
			...
			<tr>      
				...
				<td class="a">
					<input type="button" value="Register" onclick="location.href='registration.php';"></a>
				</td>
			</tr>
