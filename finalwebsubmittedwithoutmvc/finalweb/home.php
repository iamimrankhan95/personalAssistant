...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    global $connection;
    if ($connection) {
        echo $sql = "UPDATE reminder SET comment=\"$comment\" WHERE id=\"$id\" AND date=\"$today\" AND AT =\"$time\" ";
        mysqli_query($connection, $sql);
        echo "hyyyyy";
    } else {
        echo "not connected";
    ...
    <div id="header">
        <table border="0" width="100%">
            <tr>
                <td>
                    <ul id="menubar">
                        <li><a href="home.php">Refresh</a></li>
                        <li><a href="www.wikipedia.org">Wikipedia</a></li>
                        <li><a href="user.php">Profile</a></li>
                        <li><a href="calo.html">Calender</a></li>
            ...
            <table class="event" width="100%">
                ...
                if ($result = mysqli_query($connection, $sql)) {
                    ...
                    <tr>
                        ...
                        <td id='e'><a href='delete.php?state=event&date=$today&at=$row[1]'>Remove</a></td>
                        <td id='e'><a href='record.php?state=modify&date=$today&event=$row[0]&at=$row[1]&location=$row[2]&with=$row[3]&note=$row[4]'>Edit</a></td>
                    </tr>
